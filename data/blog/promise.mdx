...
1. 프로미스의 상태 <span style={{color: '#606060'}}>_(pending, fulfilled, rejected)_</span>
2. Producer 와 Consumer <span style={{color: '#606060'}}>_(executor, then, catch, finally)_</span>
